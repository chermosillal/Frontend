...
export default function UserBar({ isLoggedIn, userName, userRole, onLoginClick, onLogoutClick, onShowProfile, onAddProd, onModProd }) {
  return (
        ...
        <div className="userbar-info">
          ...
          {userRole === 'admin' && (
            <>
              ...
              <a className="userbar-admin-link" href="#" onClick={e => { e.preventDefault(); onModProd && onModProd(); }}>Mod Prod</a>
            </>
          )}
